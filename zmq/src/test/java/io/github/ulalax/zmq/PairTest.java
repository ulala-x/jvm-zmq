    ...
    class BasicPairCommunication {
        ...
        void should_Exchange_Messages_Bidirectionally() throws Exception {
            ...
            try (Context ctx = new Context();
                ...
                byte[] received1 = socket2.recvBytes();
                ...
                byte[] received2 = socket1.recvBytes();
        ...
        void should_Support_Full_Duplex_Communication() throws Exception {
            ...
            try (Context ctx = new Context();
                ...
                byte[] msg1 = socket2.recvBytes();
                byte[] msg2 = socket1.recvBytes();
    ...
    class ExclusiveConnection {
        ...
        void should_Maintain_Exclusive_One_To_One_Connection() throws Exception {
            ...
            try (Context ctx = new Context();
                ...
                byte[] received = socket2.recvBytes();
    ...
    class MessageOrder {
        ...
        void should_Preserve_Message_Order() throws Exception {
            ...
            try (Context ctx = new Context();
                ...
                for (int i = 0; i < 5; i++) {
                    byte[] received = receiver.recvBytes();
                    assertThat(received).isNotNull();
                    assertThat(new String(received, StandardCharsets.UTF_8))
                            .as("Message order #" + i)
                            .isEqualTo("Message-" + i);
